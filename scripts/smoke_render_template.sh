...
search 'ingest_loader = "playwright"' "$out/worai.toml"
search 'playwright_wait_until = "domcontentloaded"' "$out/worai.toml"
search 'playwright_headless = true' "$out/worai.toml"
search 'ingest_timeout_ms = 10000' "$out/worai.toml"
