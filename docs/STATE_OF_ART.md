# State of the Art (March 12, 2026)
...
- Runtime template is aligned with SDK `6.15.1` canonical cloud workflow contract (`ingest_source`, `ingest_loader`, `ingest_timeout_ms`).
